...
UNION
               ...
               vo1.name ::character varying(50) as  "Project Verantw.",
               ...
               LEFT JOIN
               (Select pv.prj_id, o.org_id, o.name from "{schemaname}"."PRJ_LINK" pv JOIN "{schemaname}"."ORG" o
                ON pv.org_id=o.org_id and o.parent_id is not null and o.org_id > 12 AND o.org_id < 21
               group by pv.prj_id, o.org_id, o.name) vo1 on vo1.prj_id=b1.prj_id
...
UNION
               ...
               vo2.name ::character varying(50) as "Project Verantw.",
     ...
     JOIN "{schemaname}"."PRJ" c2 ON b2.prj_id=c2.parent_id
               ...
               (Select pv.prj_id, o.org_id, o.name from "{schemaname}"."PRJ_LINK" pv JOIN "{schemaname}"."ORG" o
                ON pv.org_id=o.org_id and o.parent_id is not null and o.org_id > 12 AND o.org_id < 21
               group by pv.prj_id, o.org_id, o.name) vo2 on vo2.prj_id=b2.prj_id
...
*/
DROP materialized VIEW "{schemaname}"."v_timetell_projectenoverzicht_3";
