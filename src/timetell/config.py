...
logger = logging.getLogger('timetell')
...
DEFAULT_CONFIG_PATHS = [
    pathlib.Path('/etc') / 'timetell.yml',
    pathlib.Path('timetell.yml')
]
...
def _config_path(config_path: str) -> pathlib.Path:
    # language=rst
    ...
    """
    config_paths = [pathlib.Path(config_path)] \
...
def load(config_path: str=None) -> ConfigDict:
    # language=rst
