...
DROP VIEW IF EXISTS "{schemaname}"."viw_timetell_ivdi";
DROP VIEW IF EXISTS "{schemaname}"."viw_tableau_hrs_union_all_normuren";
DROP VIEW IF EXISTS "{schemaname}"."viw_tableau_normuren_per_werkdag";
DROP VIEW IF EXISTS "{schemaname}"."viw_tableau_emp";
DROP VIEW IF EXISTS "{schemaname}"."viw_tableau_datum";
--------------------------------------------------------------
-- 1/x: vw_tableau_act
--------------------------------------------------------------
...
--------------------------------------------------------------
-- 12/x: viw_tableau_normuren_per_werkdag
--------------------------------------------------------------
...
--------------------------------------------------------------
-- 13/x: viw_tableau_hrs_union_all_normuren
--------------------------------------------------------------
